defmodule AwesomeApiV2.Web.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AwesomeApiV2.MyChannel do
        use AwesomeApiV2.Web, :channel
        alias AwesomeApiV2.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :awesome_api_v2,
                        pubsub_server: AwesomeApiV2.PubSub
end
